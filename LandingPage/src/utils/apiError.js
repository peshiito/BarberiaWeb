...
const KNOWN_MESSAGES = {
    ...
    "Slot already taken": "Ese horario se acaba de ocupar. Elegí otro y confirmá de nuevo.",
    "Weekly appointment limit reached": "Ya tenés el máximo de turnos permitidos para esta semana.",
    "Client already has an appointment that day": "Ya tenés un turno reservado ese día. Si querés cambiarlo, escribinos por WhatsApp.",
    "This barber does not offer the selected service": "Ese barbero no hace el servicio elegido. Elegí otro barbero.",
    "Service not found": "Ese servicio ya no está disponible. Elegí otro.",
